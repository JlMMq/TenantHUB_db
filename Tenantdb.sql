...
CREATE TABLE Tb_Espacio(
	...
	dou_area FLOAT DEFAULT 0 NOT NULL,
	str_unid VARCHAR(5) DEFAULT 'm2' NOT NULL,
	int_opert INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE Tb_Contrato(
	...
	dec_monto DECIMAL DEFAULT 0 NOT NULL,
	dec_garantia DECIMAL DEFAULT 0 NOT NULL,
	dec_mora DECIMAL DEFAULT 0 NOT NULL,
	date_inicioCont DATE NOT NULL,
	date_finCont DATE NOT NULL,
	int_nroMeses INTEGER DEFAULT 0 NOT NULL,
	int_tipo INTEGER DEFAULT 1 NOT NULL, 
	str_rubro  VARCHAR(50) NULL,
	bin_archivo VARBINARY(MAX) NULL,
...
INSERT INTO Tb_Provincia(str_codProvin,str_nombre,str_codDepart)
VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
